...
- pause_status: `implement_review_pending_runtime_evidence`
- resume_prerequisites:
  - `Emit the four bounded IMPLEMENT artifacts`
  - `Verify authority refs resolve under control`
  - `Re-submit the IMPLEMENT packet as implement-complete review`

## terminate
- reports_archive_ref: `/home/_404/src/loop_ledger/dist/workbench-prompt-registry-001-implement-review-001.iteration-0001.review.zip`
- ledger_bundle_ref: `/home/_404/src/loop_ledger/bundles/loop_pipeline/workbench-prompt-registry-001-implement-review-001/iteration-0001`
