...
`just review-bundle <manifest>` now performs the full controller flow:

- validate manifest shape
- verify declared inputs exist
- materialize the copied bundle
- pack the bundle into `dist/*.review.zip`
